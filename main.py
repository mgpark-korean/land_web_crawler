...
for landElement in landElementList:
    ...
    try:
        move_to_click_element(landElement)
        ...
        if landElement.find_element_by_class_name('complex_title'):
            ...
            for articleQty in articleQtyList:
                ...
                if buyingType in ['매매', '전세']:
                    move_to_click_element(articleQty)
                    ...
                    #
                    while True:
                        driver.execute_script('let scrollDiv = document.querySelector("#complexOverviewList .item_list"); scrollDiv.scrollTo(0, scrollDiv.scrollHeight)')
                        time.sleep(0.2)
                        newScrollHeight = driver.execute_script('return document.querySelector("#complexOverviewList .item_list").scrollHeight')
